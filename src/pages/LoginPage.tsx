    ...
    >
      <div className="w-full max-w-sm flex flex-col items-center gap-6">
        ...
        <div className="flex flex-col items-center gap-2">
          ...
          <h1 className="text-4xl font-bold" style={{ color: '#FF6B35' }}>
            FitLife
          </h1>
        ...
        <div className="w-full flex flex-col items-center gap-4 mt-4">
          ...
          >
            {loading ? (
              <span
                className="w-5 h-5 rounded-full border-2 border-gray-300 border-t-gray-700 animate-spin"
              />
            ) : (
          ...
          <p className="text-xs text-center" style={{ color: '#636366' }}>
